...
public class prob3 {
    ...
    public static void ValidateEmail(String email) throws InvalidEmailException{
        String emailRemex = 
         ...
         "[a-zA-Z0-9.-]+"+
         "\\.[a-zA-Z]{2,}$";
         if(!email.matches(emailRemex)){
            throw new InvalidEmailException("Invalid email");
         }
    }

    public static final Logger logger = Logger.getLogger(prob3.class.getName());
    public static void main(String[] args) {
      ...
      try{
        ...
        prob3.ValidateUsername(name);;

        System.out.println("Enter age");
        int age = sc.nextInt();
        prob3.ValidateAge(age);
        sc.nextLine();
        
        System.out.println("Enter mail");
        String mail = sc.nextLine();
        prob3.ValidateEmail(mail);
